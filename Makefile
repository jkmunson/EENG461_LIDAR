...
CFLAGS	= -mthumb ${CPU} ${FPU} -Og -ffunction-sections -fno-builtin -fdata-sections -MD -std=c17 -Wall -Wextra -Wdouble-promotion -Wno-unused -pedantic -c -Dgcc -g -I driver -I src -I sys 
