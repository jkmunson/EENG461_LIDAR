...
CFLAGS	= -mthumb ${CPU} ${FPU} -Og -ffunction-sections -fno-builtin -fdata-sections -MD -std=gnu17 -Wall -Wextra -Wdouble-promotion -Wno-unused -c -Dgcc -g -I driver -I src -I sys 
